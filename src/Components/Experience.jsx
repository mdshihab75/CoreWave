    ...
    <section className='mt-21.25'>
        <Container>
            <div className='flex gap-36.25 items-center'>
                ...
                <button className='font-Lato font-semibold text-base text-primary-green px-6.25 py-[14.5px] bg-seventh-color rounded-[5px] mt-[59.5px] cursor-pointer'>Learn More</button>
            </div>
            <div className='w-2/4'>
